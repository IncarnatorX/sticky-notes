...
const NoteCard = ({ note }) => {
  ...
  function mouseMove(e) {
    ...
    //2 - Update start position for next move. So that we new position is the current position from there we can recalculate the position if we further move the card.
    mouseStartPos.x = e.clientX;
    mouseStartPos.y = e.clientY;
  ...
  return (
    ...
    >
      <div
        ...
        onMouseDown={mouseDown} // mouseDown function is trigged
